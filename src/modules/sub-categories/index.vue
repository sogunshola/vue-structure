...
import { subCategoryStore } from './sub-category.store';

@Component
export default class SubCategoriesPage extends mixins(DataTableMixin) {
  formEvent = Constants.subCategoryForm;
